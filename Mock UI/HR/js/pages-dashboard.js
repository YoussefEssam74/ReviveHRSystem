...
function renderDashboard() {
  ...
  <div class="space-y-4 font-sans text-charcoal-800 pb-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
      ...
      <div class="lg:col-span-7 bg-white rounded-xl border border-charcoal-200 shadow-2xs overflow-hidden flex flex-col">
        ...
        <div class="divide-y divide-charcoal-100 p-3 space-y-2.5">
      ...
      <div class="lg:col-span-5 space-y-4">
        ...
        <div class="bg-white rounded-xl border border-charcoal-200 p-4 shadow-2xs">
        ...
        <div class="bg-white rounded-xl border border-charcoal-200 p-4 shadow-2xs">
          <div class="flex items-center justify-between mb-3">
            <div>
              <h3 class="text-xs font-bold text-charcoal-900 uppercase tracking-wide">Branches Oversight</h3>
              <p class="text-[10px] text-charcoal-400">Headcount & active operations</p>
            </div>
            <button onclick="openGymsOverviewModal()" class="text-xs text-brand-600 hover:text-brand-800 font-semibold">View All →</button>
          </div>

          <div class="space-y-2">
            ${MOCK.gymList.map(g => `
              <div onclick="setGymFilter('${g.id}')" class="p-2.5 rounded-lg bg-charcoal-50/70 hover:bg-charcoal-100/70 transition-colors flex items-center justify-between cursor-pointer text-xs border border-charcoal-100">
                <div class="flex items-center gap-2.5">
                  <div class="w-2.5 h-2.5 rounded-full bg-emerald-500"></div>
                  <div>
                    <p class="font-bold text-charcoal-900 text-xs">${g.branch}</p>
                    <p class="text-[10px] text-charcoal-400">${g.name}</p>
                  </div>
                </div>
                <div class="text-right">
                  <span class="font-bold text-charcoal-900 text-xs">${g.employees}</span>
